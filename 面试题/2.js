...
// const merge = (arr) => {
//     return arr.reduce((acc,curr,i,origin) => {
//         return curr === origin[i+1] ? acc : [...acc,curr]
//     },[])
// }
// console.log(merge([2,2,3,2]));
...
//     const fnList = Array.from(arguments);
//     return function() {
//         const args = Array.from(arguments);
//         let temp,ret;
//         fnList.forEach((fn,index) => {
//             if(index === 0){
//                 temp = fn.apply(null,args)
//             }else if(index === (fnList.length - 1)){
//                 ret = fn(temp)
//             }else{
//                 temp = fn(temp)
//             }
